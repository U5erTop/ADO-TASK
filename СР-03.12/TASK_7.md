...
Программа выводит:
1. ✅ Все курсы и оценки конкретного студента
2. ✅ Всех студентов на конкретном курсе
3. ✅ Соучащихся (студентов на одних курсах)
4. ✅ Полную информацию о всех регистрациях
5. ✅ Среднюю оценку каждого студента
6. ✅ Среднюю оценку по каждому курсу
7. ✅ Лучших студентов (с фильтром по минимальной оценке)
